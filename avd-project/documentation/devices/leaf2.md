...
- [Management](#management)
  ...
  - [NTP](#ntp)
    - [NTP Summary](#ntp-summary)
      - [NTP Local Interface](#ntp-local-interface)
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_SPINE1_Ethernet2 | routed | - | 172.30.255.3/31 | default | 1500 | false | - | - |
...
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 192.0.254.4/32 |
